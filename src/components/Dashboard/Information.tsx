    ...
    <>
       <div className="flex w-[84vw] min-h-[30vh] justify-between">
            <div className="relative flex w-[50vw] pl-5 justify-between bg-white rounded-xl">
              ...
              <div>
                    <img src="/src/assets/images/images/og-image 1.png" alt="chakra" className="min-w-64 rounded-2xl my-4"/>
              </div>
    
            </div>
    
            <div className="w-[30vw] mr-4 my-2 bg-white rounded-xl bg-[url('/src/assets/images/images/bg_information.png')] bg-no-repeat bg-cover relative">
