...
return (
<>
   <div className="flex flex-col min-w-[15vw] h-auto float-left bg-[#F8F9FA]">
        <div className="m-8"> 
        ...
        <div className="mx-8 min-h-8 w-[80%] bg-white py-5 pl-3 rounded-xl">
            ...
            <h1 className="inline font-semibold">Dashboard</h1>
        </div>

        <div className="mx-8 min-h-8 w-[80%] py-5 pl-3 rounded-xl">
            ...
            <h1 className="inline font-semibold text-[#A0AEC0]">Tables</h1>
        </div>
        ...
        <div className="mx-8 min-h-8 w-[80%] py-5 pl-3 rounded-xl">
            ...
            <h1 className="inline font-semibold text-[#A0AEC0]">Billing</h1>
        </div>
        ...
        <div className="mx-8 min-h-8 w-[80%] py-5 pl-3 rounded-xl">
            ...
            <h1 className="inline font-semibold text-[#A0AEC0]">RTL</h1>
        </div>

        <h1 className="inline font-semibold text-xl ml-8 text-[#2D3748] my-8">ACCOUNT PAGES</h1>

        <div className="mx-8 min-h-8 w-[80%] py-5 pl-3 rounded-xl">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-12 h-12 text-[#4FD1C5] mr-4 mb-1 p-3 bg-white rounded-2xl inline">
                <path fillRule="evenodd" d="M7.5 6a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM3.751 20.105a8.25 8.25 0 0 1 16.498 0 .75.75 0 0 1-.437.695A18.683 18.683 0 0 1 12 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 0 1-.437-.695Z" clipRule="evenodd" />
            </svg>
            <h1 className="inline font-semibold text-[#A0AEC0]">Profile</h1>
        </div>
        ...
        <div className="mx-8 min-h-8 w-[80%] py-5 pl-3 rounded-xl">
            ...
            <h1 className="inline font-semibold text-[#A0AEC0]">Sign in</h1>
        </div>
        ...
        <div className="mx-8 min-h-8 w-[80%] py-5 pl-3 rounded-xl">
            ...
            <h1 className="inline font-semibold text-[#A0AEC0]">Sign Up</h1>
        </div>
