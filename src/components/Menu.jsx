...
<>
   <div className="flex flex-col min-w-[15vw] h-auto float-left bg-[#F8F9FA]">
        ...
        <div className="mx-5 min-h-8 w-[80%] bg-white py-3 pl-3 rounded-xl">
        ...
        <div className="mx-5 min-h-8 w-[80%] py-3 pl-3 rounded-xl">
        ...
        <div className="mx-5 min-h-8 w-[80%] py-3 pl-3 rounded-xl">
            ...
            <h1 className="inline font-semibold text-[#A0AEC0] text-sm">Sign in</h1>
        </div>
