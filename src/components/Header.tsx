...
<>
   <div className="flex w-[83vw] justify-between mt-8 mr-3">
        ...
        <div className="flex" >
            <SearchBar/>
            <button className="text-[#718096] font-bold hover:text-[#4b6079] h-5 mt-3 hover:cursor-pointer">
            ...
            <div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 mt-3 ml-4 text-[#718096] hover:text-[#4b6079] hover:cursor-pointer">
            ...
            <div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 mt-3 mx-4 text-[#718096] hover:text-[#4b6079] hover:cursor-pointer">
