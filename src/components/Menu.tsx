...
const Menu = ()=>{
    ...
    <>
       <div className="flex flex-col min-w-[15vw] max-w-[18vw] h-auto float-left bg-[#F8F9FA]">
            ...
            <div className="mx-5 min-h-8 w-[80%] bg-white py-3 pl-3 rounded-xl hover:cursor-pointer">
                <Link to="/">
            ...
            <div className="mx-5 min-h-8 w-[80%] py-3 pl-3 rounded-xl hover:cursor-pointer">
                <Link to="/tables">
